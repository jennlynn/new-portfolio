  ...
  return (   
    <div className={cx("PortfolioSection", {"isActive" : isActive})}>
      ...
      <div className={cx("PortfolioSection-content", {"isActive": isActive})}>
        ...
        <PortfolioItem src={CMBS2} name="CMBS Tai Chi site v2" meta="Wix web design & development" description="" />
        <PortfolioItem src={CMBSTaiChi} name="CMBS Tai Chi site v1" meta="web design, development, Wordpress implementation" description="" />
        <PortfolioItem src={HomeDash} name="Hamoe Assistant Dashboard" meta="the banners were fun, but I might remove them soon, haha" description="" />
